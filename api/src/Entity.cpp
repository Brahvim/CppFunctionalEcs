...
namespace ecs {
    ...
    static std::unordered_map<ecs::entity, std::vector<ecs::destructor_cbck_t>> s_destructor_callbacks;
...
#pragma region // Memory management.
    ecs::entity create_entity() {
        if (s_free_entities.empty()) {
            ...
            const ecs::entity to_ret = s_free_entities.back();
...
#pragma region // Callback management.
    void add_entity_destructor(ecs::entity p_entity, ecs::destructor_cbck_t p_destructor) {
        s_destructor_callbacks[p_entity].push_back(p_destructor);
    }

    void remove_entity_destructor(ecs::entity p_entity, ecs::destructor_cbck_t p_destructor) {
